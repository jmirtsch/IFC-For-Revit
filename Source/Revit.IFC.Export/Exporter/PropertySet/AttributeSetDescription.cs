...
namespace Revit.IFC.Export.Exporter.PropertySet
{
   ...
   public class AttributeSetDescription : Description
   {
      ...
      /// </summary>
      Dictionary<Tuple<PropertyType,string>, AttributeSetEntry> m_Entries = new Dictionary<Tuple<PropertyType,string>, AttributeSetEntry>();

      /// <summary>
      /// The entries stored in this property set description.
      /// </summary>
      public void AddEntry(AttributeSetEntry entry)
      { 
         m_Entries[new Tuple<PropertyType,string>(entry.PropertyType, entry.PropertyName)] = entry;
      }

      public AttributeSetEntry GetEntry(PropertyType propertyType, string name)
      {
         AttributeSetEntry result = null;
