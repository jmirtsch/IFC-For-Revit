...
namespace Revit.IFC.Export.Exporter.PropertySet.Calculators
{
   ...
   class TreadLengthAtInnerSideCalculator : PropertyCalculator
   {
      ...
      public override bool Calculate(ExporterIFC exporterIFC, IFCExtrusionCreationData extrusionCreationData, Element element, ElementType elementType)
      {
         ...
         if (ParameterUtil.GetDoubleValueFromElementOrSymbol(element, "TreadLengthAtInnerSide", out m_TreadLengthAtInnerSide) != null)
            m_TreadLengthAtInnerSide = UnitUtil.ScaleArea(m_TreadLengthAtInnerSide);
