...
{
   class TemperatureCalculator : PropertyCalculator
   {
      /// <summary>
      ...
      /// </summary>
      static TemperatureCalculator s_Instance = new TemperatureCalculator();

      /// <summary>
      /// The SpaceTemperatureCalculator instance.
      /// </summary>
      public static TemperatureCalculator Instance
      {
      ...
      {
         if (String.Compare(paramName, "SpaceTemperatureSummer", true) == 0)
            return m_SpaceTemperatureSummer;
         if (String.Compare(paramName, "SpaceTemperatureWinter", true) == 0)
