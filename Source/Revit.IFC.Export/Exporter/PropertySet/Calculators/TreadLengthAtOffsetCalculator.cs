...
namespace Revit.IFC.Export.Exporter.PropertySet.Calculators
{
   ...
   class TreadLengthAtOffsetCalculator : PropertyCalculator
   {
      ...
      public override bool Calculate(ExporterIFC exporterIFC, IFCExtrusionCreationData extrusionCreationData, Element element, ElementType elementType)
      {
         ...
         if (ParameterUtil.GetDoubleValueFromElementOrSymbol(element, "TreadLengthAtOffset ", out m_TreadLengthAtOffset) != null)
            m_TreadLengthAtOffset = UnitUtil.ScaleArea(m_TreadLengthAtOffset);
