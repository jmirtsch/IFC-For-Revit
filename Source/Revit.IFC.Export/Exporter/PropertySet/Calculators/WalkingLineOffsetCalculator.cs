...
namespace Revit.IFC.Export.Exporter.PropertySet.Calculators
{
   ...
   class WalkingLineOffsetCalculator : PropertyCalculator
   {
      ...
      public override bool Calculate(ExporterIFC exporterIFC, IFCExtrusionCreationData extrusionCreationData, Element element, ElementType elementType)
      {
         ...
         if (ParameterUtil.GetDoubleValueFromElementOrSymbol(element, "WalkingLineOffset", out m_WalkingLineOffset) != null)
            m_WalkingLineOffset = UnitUtil.ScaleArea(m_WalkingLineOffset);
