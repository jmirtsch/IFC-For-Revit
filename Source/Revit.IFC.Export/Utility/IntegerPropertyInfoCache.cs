...
namespace Revit.IFC.Export.Utility
{
    ...
    /// </summary>
    public class IntegerPropertyInfoCache : Dictionary<KeyValuePair<string, int>, IfcProperty>
    {
        /// <summary>
        ...
        public IfcProperty Find(string propertyName, int value)
        {
        ...
        public void Add(string propertyName, int value, IfcProperty propertyHandle)
        {
            KeyValuePair<string, int> key = new KeyValuePair<string, int>(propertyName, value);
