...
namespace Revit.IFC.Import.Data
{
    public class IFCTriangulatedFaceSet : IFCRepresentationItem
    {
        ...
        /// <summary>
        /// List of Normal indexes (index to the normals in the list of normals in the Normals attribute
        /// </summary>
