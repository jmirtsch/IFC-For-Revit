...
namespace Revit.IFC.Import.Utility
{
    ...
    public class IFCImportShapeEditScope : IDisposable
    {
           ...
           out bool hasInvalidData, out TessellatedShapeBuilderOutcome outcome)
        {
            ...
            {
                IFCImportFile.TheLog.LogError(CreatorId(), ex.Message, false);
        ...
        /// </summary>
        public void StartCollectingFaceSetForBrepBuilder()
        {
        }
        ...
        /// Placeholder function
        /// </summary>
        public void StartCollectingFaceForBrepBuilder(Surface surface, bool orientation) 
        {
        }
        ...
        /// Placeholder function
        /// </summary>
        public void StopCollectingFaceForBrepBuilder() 
        {
        }
        ...
        /// Placeholder function
        /// </summary>
        public void InitializeNewLoopForBrepBuilder() 
        {
        }
        ...
        /// Placeholder function
        /// </summary>
        public IList<GeometryObject> CreateGeometry(string guid, bool useBrepBuilder)
        {
            return null;
        }
    }
