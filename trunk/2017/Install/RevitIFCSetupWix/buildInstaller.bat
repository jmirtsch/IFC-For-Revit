...
light.exe -ext WixUtilExtension -out RevitIFC2017.msi product.wixobj -ext WixUIExtension

copy RevitIFC2017.msi %1..\Releasex64
del RevitIFC2017.msi

echo %1..\Releasex64\RevitIFC2017.msi
