...
light.exe -ext WixUtilExtension -out RevitIFC2015.msi product.wixobj -ext WixUIExtension

copy RevitIFC2015.msi %1..\Releasex64
del RevitIFC2015.msi

echo %1..\Releasex64\RevitIFC2015.msi
