...
namespace Revit.IFC.Export.Utility
{
    ...
    class ElementFilteringUtil
    {
        ...
        private static bool ShouldCategoryBeExported(ExporterIFC exporterIFC, Element element)
        {
            ...
            if (!foundName || (exportType != IFCExportType.DontExport && exportType != IFCExportType.IfcOpeningElement))
                return true;
        ...
        public static bool IsElementVisible(Element element)
        {
            ...
            bool temporaryVisible = (filterView != null) ? filterView.IsElementVisibleInTemporaryViewMode(TemporaryViewMode.TemporaryHideIsolate, element.Id) : true;
